class Arguments:
    ...
    def __init__(self, trainer: str, root: str, dataset: str, config: str, ctp: str, n_ctx: int, shots: int, csc: bool, output_dir: str):
    ...
    def __str__(self):
        return (f"backbone={self.backbone}, config_file={self.config_file}, dataset_config_file={self.dataset_config_file}, "
                ...
                f"target_domains={self.target_domains}, trainer={self.trainer}, transforms={self.transforms}")
